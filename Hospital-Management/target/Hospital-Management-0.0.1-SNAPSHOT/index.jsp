...
<body>
	...
	<section class="container space">
		<img src="aaaa.jpg" alt="..." class="rounded">
	</section>
	...
	<section class="container border border-dark space bgcolor">
		...
		<p class="text-lg">This is a hospital management user interface
			...
			interface, combined with strong management capabilities.
			The software provides individual interfaces to various stakeholders
			of the hospital to help them effectively capture, access, and manage
			crucial information on hospital functioning. 
			</p>
	</section>
</body>
</html>